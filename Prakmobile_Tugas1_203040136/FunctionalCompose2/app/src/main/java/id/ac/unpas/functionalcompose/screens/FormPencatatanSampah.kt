...
fun FormPencatatanSampah(setoranSampahDao: SetoranSampahDao) {
    val tanggalpinjam = remember { mutableStateOf(TextFieldValue("")) }
    val nama = remember { mutableStateOf(TextFieldValue("")) }
    val judulbuku = remember { mutableStateOf(TextFieldValue("")) }
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            value = tanggalpinjam.value,
            onValueChange = {
                tanggalpinjam.value = it
            },
            modifier = Modifier
                .padding(4.dp)
                .fillMaxWidth(),
        ...
        Row (modifier = Modifier
            ...
            Button(modifier = Modifier.weight(5f), onClick = {
                ...
                val item = SetoranSampah(id, tanggalpinjam.value.text, nama.value.text, judulbuku.value.text, harga.value.text)
                scope.launch {
                    setoranSampahDao.insertAll(item)
                }
                tanggalpinjam.value = TextFieldValue("")
                nama.value = TextFieldValue("")
                judulbuku.value = TextFieldValue("")
