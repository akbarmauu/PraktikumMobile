            ...
            items(items = items, itemContent = { item ->
                Row(modifier = Modifier
                    ...
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Tanggal Peminjaman", fontSize = 14.sp)
                        Text(text = item.tanggalpinjam, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Nama Peminjam", fontSize = 14.sp)
                        Text(text = item.nama, fontSize = 16.sp, fontWeight =
                        FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Judul Buku", fontSize = 14.sp)
                        Text(text = item.judulbuku, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
